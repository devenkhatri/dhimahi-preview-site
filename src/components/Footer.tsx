...
import { getGeneralSettings, type SocialMediaLinks } from "@/lib/settings";
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <div className="space-y-2 text-gray-300">
              <p>📧 {settings?.contactEmail || "hello@dhimahitechnolabs.com"}</p>
              <p>📞 {settings?.phone || "+91-9033033836"}</p>
