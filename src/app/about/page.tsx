                        ...
                        <div className="max-w-4xl mx-auto text-center">
                            ...
                            <div className="flex justify-center space-x-6 mb-12">
                                <a
                                    ...
                                    className="flex items-center space-x-3 bg-[#0077B5] text-white px-6 py-3 rounded-xl hover:bg-[#005885] transition-colors duration-200"
                                >
                                ...
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="flex items-center space-x-3 bg-[#1DA1F2] text-white px-6 py-3 rounded-xl hover:bg-[#0d8bd9] transition-colors duration-200"
                                >
                                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="flex items-center space-x-3 bg-[#1877F2] text-white px-6 py-3 rounded-xl hover:bg-[#166fe5] transition-colors duration-200"
                                >
                                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="flex items-center space-x-3 bg-gradient-to-r from-[#E4405F] to-[#C13584] text-white px-6 py-3 rounded-xl hover:from-[#d73653] hover:to-[#b02a7a] transition-colors duration-200"
                                >
                                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
                                ...
                                <a
                                    ...
                                    target="_blank"
                                    rel="noopener noreferrer"
                                    className="flex items-center space-x-3 bg-[#FF0000] text-white px-6 py-3 rounded-xl hover:bg-[#e60000] transition-colors duration-200"
                                >
                                    <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
